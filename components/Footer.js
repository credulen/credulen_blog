		...
		<div className="bg-primary dark:bg-gray-900">
			<div className="container px-6 py-12 mx-auto">
				...
				<div className="grid lg:grid-flow-col auto-cols-fr border-b-2 border-gray-400 pb-10">
					...
					<div>
						<div className="">
							{/* <h6 className="max-w-lg text-xl font-semibold tracking-tight text-gray-800 xl:text-2xl dark:text-white"> */}
							<h6 className="max-w-lg font-semibold text-primary-light lg:mt-0 md: mt-10 sm:mt-4">
								Subscribe our newsletter to get update
							</h6>

							<div className="flex flex-col mx-auto mt-4 space-y-3 md:space-y-0 md:flex-col">
								{/* <input
									id="email"
									type="text"
								...
								{/* <button className="px-6 py-2.5 text-sm font-medium tracking-wider text-white transition-colors duration-300 transform md:w-auto md:mx-4 focus:outline-none bg-gray-800 rounded-lg hover:bg-gray-700 focus:ring focus:ring-gray-300 focus:ring-opacity-80">
									Subscribe
								</button> */}
