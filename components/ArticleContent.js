...
const ArticleContent = async () => {
	const singleArticle = await getAllArticles();
	// console.log(singleArticle.data);
	// console.log(singleArticle.data[0].attributes.category);
	// console.log(singleArticle.data.id);
	// console.log(singleArticle.data[0].id);
	// console.log(singleArticle.data[0].attributes);
	// console.log(singleArticle.data[0].attributes.Title);
	// console.log(singleArticle.data[0].attributes.Body);
	// console.log(singleArticle.data[0].attributes.Slug);
	// console.log(singleArticle.data[0].attributes.createdAt);
	// console.log(singleArticle.data[0].attributes.updatedAt);
	// console.log(singleArticle.data[0].attributes.publishedAt);
	// console.log(singleArticle.data[0].attributes.Image.data.id);
	// console.log(singleArticle.data[0].attributes.Image.data.attributes.name);
...
export async function getArticleBody({ params }) {
